...
<style>
	...
	<div class="hyo_register_user">
		<div class="hyo_register_main-box">
			...
			<form class="hyo_register_form" method="post" action="<%=request.getContextPath()%>/creatorJoin" autocomplete="off" >
				...
				<div id="hyo_register_nick" class="hyo_register_input-group">
					<span class="hyo_register_input-outline">
						<span class="hyo_register_input-box">
							<input type="text" id="member_nick" name="nick" class="hyo_register_input" placeholder="닉네임" autocomplete=”off” maxlength="13"/>				
						</span>
					</span>
				</div>
