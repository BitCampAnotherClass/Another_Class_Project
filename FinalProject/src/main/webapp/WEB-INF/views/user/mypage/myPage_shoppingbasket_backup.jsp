		...
		$.ajax({// 회원아이디 가져감.....
			...
			success:function(b){
				...
				bb.each(function(idx,vo){	//성공해서 정보담아옴
					//vo.basket
					tag += "<li>";
					tag += "<div><input type='checkbox' class='checkbb' name='classNoPayList' value='"+vo.class_option_no +"' ><label style='display:inline-block;visibility hidden;'><input type='checkbox' class='checkbb' name='classNoDelList' value='"+vo.class_option_no +"' ></label></div>";
					tag += "<div>";
					tag += "<div>";
