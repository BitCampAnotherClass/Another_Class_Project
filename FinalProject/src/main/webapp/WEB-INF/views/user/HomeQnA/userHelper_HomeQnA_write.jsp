...
<style>
	/*제일겉에있는 Div*/
	#hQnAWriteD{width:1200px;height:auto;margin:0 auto;}
	...
	<div id="hQnAWriteD">
		...
		<form>
			<ul>
				...
				<li id="hQnABut">
				<input type="button" name="hQnAWCan" id="hQnAWCan" value="취소"/><input type="submit" name="hQnAWSubmit" id="hQnAWSubmit" value="등록"/>
				</li>				
			</ul>
		</form>
