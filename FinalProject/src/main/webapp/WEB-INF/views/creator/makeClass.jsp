...
<div class="container">
	...
	<div class="followDiv">
		<ul>
			<li><div class="followButton" style="color:white">1</div>클래스명</li>
			<li><div class="followButton" style="color:white">2</div>클래스간단소개</li>
			<li><div class="followButton" style="color:white">3</div>클래스 카테고리</li>
		</ul>
	</div>
